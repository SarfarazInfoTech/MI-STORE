...
const Footer = ({footer}) => {
    return (
        ...
        <div className="PreFooter">
            ...
            <div>
                {mapIcon}
                <p> <b>Vast services network</b> <br /> 1000 Mi services-centers across 600 cities </p>
            </div>
        </div>
        <div className="PreFooter2">
            <div><p>LET'S STAY IN TOUCH</p><span>Get update on sales specials and more</span></div>
            <div>
                <div>
                    <input type="email" name="email" placeholder="Enter Email Address" />
                    <button>{svgmail}</button>
                </div>
                <span>Thanks. You're on email list for special offers.</span>
            </div>
            <div>
                <p>FOLLOW MI</p>
        ...
        <div className="footer">
            ...
            <div>
                <div>
                    Chat whit our Virtual AI Bot (24/7 Live Agent Support)
                </div>
        ...
        <div className="footerBorder">
            <div> <a href="https://www.InfoTechSarfaraz.com/">2021 © Qadri Academy All Rights Reserved | Designed and
                Developed by Sarfaraz InfoTech Inc.</a></div>
        </div>
        </>
    )
}
